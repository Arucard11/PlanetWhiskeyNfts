...
async function main() {
    console.log('🚀 Proper Lending Program Initialization...');
    ...
    try {
        ...
        console.log('\\n🏗️  Step 1: Initializing Global Market...');
        ...
        try {
            const tx1 = await program.methods
                ...
                .accounts({
                    ...
                    collectionRegistry: collectionRegistryV2Pda, // This might not be needed
        ...
        console.log('\\n🏗️  Step 3: Initializing Collection Registry V2...');
        ...
        try {
            ...
            if (error.message.includes('already in use')) {
                ...
                console.log('❌ Collection Registry V2 error:', error.message);
            }
        }
        
        // 4. Add approved collection
        console.log('\\n🏗️  Step 4: Adding approved collection...');
        ...
        try {
            ...
            if (error.message.includes('already exists')) {
                ...
                console.log('❌ Add collection error:', error.message);
            }
        }
