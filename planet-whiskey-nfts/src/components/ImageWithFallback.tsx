...
const ImageWithFallback: React.FC<ImageWithFallbackProps> = ({ 
    ...
    // If there's no valid image source or it has errored, show empty div
    if (!imageSrc || hasErrored) {
        console.log(`[ImageWithFallback] No image available - imageSrc: "${imageSrc}", hasErrored: ${hasErrored}`);
        return (
