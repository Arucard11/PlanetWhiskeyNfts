          ...
          <>
            ...
            >
              <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                <h3 className="text-lg font-semibold text-gray-300 mb-2">Total Borrowing Power</h3>
                <p className="text-3xl font-bold text-green-400">${lendingData.totalBorrowingPower}</p>
              </div>
              <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
