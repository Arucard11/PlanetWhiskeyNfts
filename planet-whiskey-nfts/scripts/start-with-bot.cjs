...
botProcess.on('exit', (code, signal) => {
  ...
  if (code !== 0) {
    console.log('⚠️ Liquidation bot exited with error, but Next.js will continue running...');
    console.log('⚠️ The liquidation bot can be restarted manually if needed.');
  } else {
    console.log('✅ Liquidation bot shut down cleanly.');
  }
});
